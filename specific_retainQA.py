...
if __name__ == "__main__":
    ...
    for model in models:
        ...
        target_file = f'/home/hyesoo/DUSK/results_target/{model}/NONE+GD/seed_1001/epoch5_1e-05_taskformats_5/1/unlearn_times_1/eval_results-last-all-interview/qa/qa_specific_retain_log.json'
        retrain_file = f'/home/hyesoo/DUSK/results_interviewx/retrain/{model}/NONE+GD/seed_1001/epoch5_1e-05_taskformats_5/1/unlearn_times_1/eval_results-last-all/qa/qa_specific_retain_log.json'
        output_file = f'/home/hyesoo/DUSK/results_chronox/eval_qa_candidates/specific_retain_{model.replace(".", "_")}.jsonl'
